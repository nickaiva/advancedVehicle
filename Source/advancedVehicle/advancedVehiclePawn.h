...
class AadvancedVehiclePawn : public AWheeledVehicle
{
	...
	/** Text component for the In-Car chronometer */
	UPROPERTY(Category = Display, VisibleDefaultsOnly, BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
		UTextRenderComponent* InCarChrono;
...
public:
	...
	/** Returns InCarChrono subobject **/
	FORCEINLINE UTextRenderComponent* GetInCarChrono() const { return InCarChrono; }
